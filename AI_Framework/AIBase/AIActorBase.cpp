...
void AIActorBase::AddBBValueVec(std::string _key, AIMath_Global::Vector2f  _value)
{
	brain->GetBrainBlackboard()->AddNewValueVec2f(_key, _value);

}
void AIActorBase::EditBBValueVec(std::string _key, AIMath_Global::Vector2f  _newValue)
{
	brain->GetBrainBlackboard()->EditValueVec2f(_key, _newValue);
}
void AIActorBase::DeleteBBValueVec(std::string _key)
{
	brain->GetBrainBlackboard()->DeleteValueVec2f(_key);
}

AIMath_Global::Vector2f  AIActorBase::GetBBValueVec(std::string _key)
{
