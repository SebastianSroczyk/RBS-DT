...
public:
	...
	void AddBBValueVec(std::string _key, AIMath_Global::Vector2f  _value);
	void EditBBValueVec(std::string _key, AIMath_Global::Vector2f  _newValue);
	void DeleteBBValueVec(std::string _key);
	AIMath_Global::Vector2f  GetBBValueVec(std::string _key);
